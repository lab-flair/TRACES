...
# ATBench representation table.
'''
TABLE_PATH = "llama3_analysis_atbench_events/event_repr_table_action_end.pkl"
TRAJ_JSONL_PATH = "analysis_atbench_events/atbench_trajectories.jsonl"

OUT_DIR = "atbench_llama3/traces_prefix_outputs_v3"
'''

TABLE_PATH = "qwen3-4b_analysis_atbench_events/event_repr_table_action_end.pkl"
TRAJ_JSONL_PATH = "analysis_atbench_events/atbench_trajectories.jsonl"

OUT_DIR = "atbench_qwen3_4b/traces_prefix_outputs_v3"
...
SPLIT_FILENAME = "atbench_train_val_test_split_ids.json"
SPLIT_STRATIFY_BY_LABEL = True
